...
gene_pool_2022 <- dbPool(drv = SQLite(), dbname = "eyeIntegration_2022_human.sqlite", idleTimeout = 3600000)
...
scEiaD_pool <- dbPool(drv = SQLite(), dbname = "scEiaD.sqlite", idleTimeout = 3600000)
